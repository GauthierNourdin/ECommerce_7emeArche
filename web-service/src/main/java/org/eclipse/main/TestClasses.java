...
public class TestClasses {
	...
	public static void main(String[] args) {
		...
		Commande commande = new Commande ("envoyee", LocalDateTime.now(), new ArrayList<LigneCommande>(), client, new Facture());
		...
		LivreImprime livreImprime = new LivreImprime("Leviathan, 5ème Edition", "Ouvrage philosophique traitant des relations sociales", 1516, 1599, livreImprimeConsultations,
		...
		LivreNumerique livreNumerique = new LivreNumerique("Notes diverses de Thomas Hobbes", "Notes écrites de la main de Thomas Hobbes. Originaux stockées à la grande bibliothèque nationale de Londres", 2843, 2999, livreNumeriqueConsultations,
