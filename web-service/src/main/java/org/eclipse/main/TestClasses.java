...
/**
 * Test manuel de toutes les classes concrètes.
 * 
...
public class TestClasses {
	...
	public static void main(String[] args) {
		...
		Adresse adresse1 = new Adresse(1, "12", "Route de Londres", "65125", "Nice", "France", "3ème étage");
		Adresse adresse2 = new Adresse(2, "44", "Allée des Acacias", "91001", "Evry", "France", "");

		Auteur auteur = new Auteur("Hobbes", "Thomas", new ArrayList<Livre>());

		Client client = new Client("Igamori", "Kito", 1, "kito@igamori.jpn", "hirito", "0458-9689-4522-2196", "08/23",
				"741", adresse1, adresse1, new Panier(), new ArrayList<Consultation>(), new ArrayList<Commande>());

		Commande commande = new Commande("envoyee", LocalDateTime.now(), new ArrayList<LigneCommande>(), client,
				new Facture());

		Consultation consultation1 = new Consultation(1, LocalDateTime.now(), client, new LivreImprime());
		Consultation consultation2 = new Consultation(2, LocalDateTime.now().minusHours(2), client,
				new LivreNumerique());

		Editeur editeur = new Editeur(1, "Philosophiae", adresse2, new ArrayList<Livre>());

		Facture facture = new Facture("payee", commande);

		Genre genre = new Genre(1, "Philosophie", new ArrayList<Livre>());

		LigneCommande ligneCommande = new LigneCommande(1, 2, 1516, 1599, new LivreImprime(), commande);
		...
		LivreImprime livreImprime = new LivreImprime("Leviathan, 5ème Edition",
				"Ouvrage philosophique traitant des relations sociales", 1516, 1599, livreImprimeConsultations,
				new ArrayList<LigneCommande>(), "2-4874-1548184-1", "Leviathan", "Poche", "image1.png", 198,
				new Date(156156418000l), livreImprimeGenres, livreImprimeAuteurs, editeur, 1, 4,
				new Date(170914852000l), new Date(167914854000l), 61.5, "g", 19.2, 13.4, 2.8, "cm");
		...
		LivreNumerique livreNumerique = new LivreNumerique("Notes diverses de Thomas Hobbes",
				"Notes écrites de la main de Thomas Hobbes. Originaux stockées à la grande bibliothèque nationale de Londres",
				2843, 2999, livreNumeriqueConsultations, livreNumeriqueLignesCommande, "3-15-787151572-6",
				"Notes de Thomax Hobbes 2", "Scans de documents originaux", "image2.png", 301, new Date(204575502000l),
				livreNumeriqueGenres, livreNumeriqueAuteurs, editeur, 2, 193.24, "Mo");
